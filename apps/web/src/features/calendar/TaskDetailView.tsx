      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4 mb-8">
            ...
            {/* Mocking additional details that might come from a detailed fetch */}
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2 border-t border-gray-100">
             {task.status !== 'completed' ? (
               <button className="flex-1 flex justify-center items-center py-3 bg-gray-900 text-white font-bold rounded-lg hover:bg-gray-800 transition-colors">
